...
#BEAMER PER LA PRESENTAZIONE AGGIORNATO AL 27/04
\documentclass{beamer}
...
% --- Informazioni Titolo ---
\title[Povertà stagionale in Nigeria]{Povertà stagionale in Nigeria}
\subtitle{Work in progress}
...
\begin{frame}{Domande di Ricerca}
    \begin{block}{Obiettivi dello studio}
        1. Quali sono le principali strategie di adattamento adottate dalle famiglie rurali durante i mesi di magra e quali riducono maggiormente la vulnerabilità economica? \vspace{0.5cm}
        
        2.Esistono differenze significative nell'evoluzione della povertà stagionale tra le zone agro-ecologiche del Nord e del Sud della Nigeria? 
    \end{block}
\end{frame}
...
% 4 UNA IMMAGINE E SPAZIO COMMENTO
\begin{frame}{Variabile dipendente: Quantità di prodotto raccolto (Kg/L)}
\framesubtitle{Domanda di ricerca n. 1} 
    \centering
    \includegraphics[width=0.4\textwidth]{Variabile dipendente.png}
    \vspace{0.5cm}
    \begin{block}{Commento}
        Inserisci qui la spiegazione dettagliata del grafico o dell'immagine soprastante. 
    \end{block}
...
% 8. REPLICA: TRE IMMAGINI E SPAZIO COMMENTO
\begin{frame}{Variabile indipendente: pesticidi, animali da trazione, macchinari}
    \framesubtitle{Domanda di ricerca n. 1} 
    \centering
    \includegraphics[width=0.3\textwidth]{grafico 1.png}
    \includegraphics[width=0.3\textwidth]{ggplot2 bar chart 17.png}
    \includegraphics[width=0.3\textwidth]{ggplot2 bar chart 18.png}
    \vspace{0.5cm}
    \begin{block}{Commento Finale}
        Breve riassunto di ciò che queste tre figure rappresentano nel contesto globale della presentazione.
    \end{exampleblock}
\end{frame}
...
% 7. REPLICA: UNA IMMAGINE E SPAZIO COMMENTO
\begin{frame}{Variabile dipendente: Quantità di prodotto raccolto (Kg/L)}
\framesubtitle{Domanda di ricerca n. 2} 
    \begin{columns}
        \begin{column}{0.5\textwidth}
            \centering
            \includegraphics[width=\textwidth]{vardip_zone.png}
